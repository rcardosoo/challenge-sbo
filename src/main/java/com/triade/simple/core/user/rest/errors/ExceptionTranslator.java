package com.triade.simple.core.user.rest.errors;

import com.triade.simple.core.user.service.UsernameAlreadyUsedException;
...
public class ExceptionTranslator implements ProblemHandling, SecurityAdviceTrait {
    ...
    @ExceptionHandler(BridgeNotFoundException.class)
    public ResponseEntity<Problem> handleBridgeNotFoundException(BridgeNotFoundException ex) {
    ...
    @ExceptionHandler(BridgeOperationNotAllowedException.class)
    public ResponseEntity<Problem> handleBridgeOperationNotAllowedException(BridgeOperationNotAllowedException ex) {
        Problem problem = Problem.builder()
    ...
    public ResponseEntity<Problem> handleEmailAlreadyUsedException(
        com.triade.simple.core.user.service.EmailAlreadyUsedException ex,
    ...
    public ResponseEntity<Problem> handleInvalidPasswordException(
        com.triade.simple.core.user.service.InvalidPasswordException ex,
        NativeWebRequest request
    ) {
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "javax.", "com.", "io.", "de.", "com.triade.simple");
    }
}
